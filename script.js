const SITE_URL = 'https://bethelight-soozhee.vercel.app';
...
async function sharePage() {
  if (navigator.share) { try { await navigator.share({ title: 'Be the Light — Sonic Remedy | Soozhee', text: 'Be the Light by Soozhee. Sonic Remedy : Audiosensory Resonance | No Regret.', url: SITE_URL }); return; } catch (e) {} }
